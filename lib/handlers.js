...
function load(client) {
  // Commands
  client.listen(COMMAND.JOIN,   onJoinCommand.bind(client));
  client.listen(COMMAND.KICK,   onKickCommand.bind(client));
  client.listen(COMMAND.MODE,   onModeCommand.bind(client));
  client.listen(COMMAND.NICK,   onNickCommand.bind(client));
  client.listen(COMMAND.PART,   onPartCommand.bind(client));
  client.listen(COMMAND.PING,   onPingCommand.bind(client));
  client.listen(COMMAND.TOPIC,  onTopicCommand.bind(client));
  client.listen(COMMAND.QUIT,   onQuitCommand.bind(client));

  // Numeric replies
  client.listen(REPLY.MYINFO,   onMyInfoReply.bind(client));
  client.listen(REPLY.NAMREPLY, onNameReply.bind(client));
  client.listen(REPLY.TOPIC,    onTopicReply.bind(client));
  client.listen(REPLY.WELCOME,  onWelcomeReply.bind(client));

  // Errors
  client.listen(EVENT.ANY,              onAnyError.bind(client));
  client.listen(ERROR.NOINVITEFORWARD,  onForwardError.bind(client));
}
