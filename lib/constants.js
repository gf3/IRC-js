...
// Export both sets of modes as this property
const MODE =
    { CHANNEL: CHANMODE
    , USER: USERMODE
    }

/** Codes that observers can use to signal stuff to IRC-js
 *  Somewhat arbitrary. The ones currently in use:
 *    ERROR   If this bit is set, an entry to the debug log is written
 *            @todo Do something more useful
 *    STOP    Set this bit to stop notification, remaining observers will not get notified
 *    REMOVE  If set, removes the observer that returned it
 *  @enum {number}
 */
const STATUS =
  { ERROR:    0
