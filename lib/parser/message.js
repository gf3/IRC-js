;(function(exports){exports.names=['','Message','Command','Params','Middle','Trailing','Prefix','Server','Person','Nick','User','Host','NonTerminating','SquareBrackets','CurlyBrackets','Backtick','AlphaNum','Letter','Num','CRLF','S','_'];exports.parse=message
message.names=exports.names
...
T=[,90112,131072,180224,207878,294912,315392,543750,331776,433158,495616,368640,,,,,413696,,,,281606,602112,94208,27823,152,11439,110592,15535,152,81071,,,138246,139264,72879,147456,72879,155648,76975,76975,76975,152,,,85167,188416,19631,196608,23727,152,211974,215558,217088,,225280,85167,52399,240646,244230,245760,,253952,85167,52399,266240,85167,152,,282624,,290816,,,303104,307200,52399,85167,,323584,31919,36015,40111,343046,344064,348160,44207,152,48303,152,85167,,376832,380928,68783,56495,,397312,401408,68783,56495,,417792,72879,76975,,434176,438272,68783,56495,60591,64687,,462848,466944,68783,56495,60591,64687,,,,,503808,507904,68783,56495,,524288,528384,68783,56495,,544768,548864,68783,56495,,565248,569344,68783,56495,,585728,589824,44207,48303,85167,7343,610304,]
...
if(typeof out=='string'){s=out;out=[];x=message(function(m,x,y){if(m=='fail')out=[false,x,y,s];if(m=='tree segment')out=out.concat(x)});x('chunk',s);x('eof');return out[0]===false?out:[true,{names:exports.names,tree:out,input:s}]}
...
})(typeof exports=='object'?exports:message={});