...
/** Bot: An IRC client wrapping up the server connection, configuration, message notifications
 ...
 *  @return {Bot}
 */
Bot.prototype.lookFor = function( command, predicate, handler ) {
 ...
 */
Bot.prototype.setMode = function( mode ) {
  // 4.2.3.2
