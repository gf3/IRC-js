...
function IRC (options) {
  ...
  function do_connect () {
    ...
    this
      ...
      .user(this.options.user.username, this.options.user.hostname, this.options.user.servername, this.options.user.realname)
  ...
  **/
  this.privmsg = function (receiver, msg) { var max_length, private_messages, i
    // 4.4.1
    ...
    for (i = 0; i < private_messages.length; i++)
      this.raw('PRIVMSG' + param(receiver) + ' ' + param(private_messages[i] || '', null, ':'))
    return this
  }
}
