 ...
 *  @return {Signal}
 */
Client.prototype.match = function(expr, handler) {
  let signal;
 ...
 *  @return {Signal}
 */
Client.prototype.matchIf = function(expr, pred, handler) {
 ...
 *  @return {Signal}
 */
Client.prototype.listen = function(type, handler) {
